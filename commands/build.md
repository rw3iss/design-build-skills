...
2. **Maintenance — `/build update`.** If the request, trimmed and lower-cased, is
   ...
   - **Stop** — do not invoke the design-build skill for an update request.
...
4. **Invoke the skill** — Use the Skill tool with `skill: "design-build"`, passing
...
6. **Follow the skill exactly** — Do what `design-build/SKILL.md` dictates. Don't
